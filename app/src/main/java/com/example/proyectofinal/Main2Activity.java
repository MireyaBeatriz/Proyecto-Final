...
public class Main2Activity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_monto) {
            Intent i = new Intent(Main2Activity.this,MontoInicial.class);
            startActivity(i);
            return true;
        }
        if (id == R.id.action_gastos) {
            Intent i = new Intent(Main2Activity.this,Gastos.class);
            startActivity(i);
            return true;
        }
        if (id == R.id.action_Lista) {
            Intent i = new Intent(Main2Activity.this,ListaMonto.class);
            startActivity(i);
            return true;
        }
        if (id == R.id.action_Lista_gasto) {
            Intent i = new Intent(Main2Activity.this,ListaGasto.class);
            startActivity(i);
            return true;
        }
